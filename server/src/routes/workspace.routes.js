const {joinRequest,getJoinRequests ,createWorkspaces, getWs, getUserWs, getW, renameW, addUser, removeUser, deleteWorkspace} = require('../controllers/workspace.controller');
